...
Net createTriangleNet(float size, PVector netPos, PVector netSpd, float radius, float m) {
  ...
  Elem elem0 = new Elem(massList.get(0), massList.get(1), size, 1, false);
  Elem elem1 = new Elem(massList.get(1), massList.get(2), size, 1, false);
  Elem elem2 = new Elem(massList.get(2), massList.get(0), size, 1, false);
  elemList.add(elem0);
  elemList.add(elem1);
  elemList.add(elem2);
